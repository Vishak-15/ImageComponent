...
import kotlinx.android.synthetic.main.camera_only.*
import java.io.File
...
class CameraOnly : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.camera_only)
...
//                        // shouldShowRequestPermissionRationale will return true
                        ...
                        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                            ...
                            Toast.makeText(this@CameraOnly,
